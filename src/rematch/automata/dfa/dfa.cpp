...
DFA::State* DFA::obtain_state(const StateSubset& ss) {
...
DFA::Transition DFA::next_base_transition(State* dq, char a) {
...
DFA::Transition& DFA::next_transition(State* q, char a) {
...
DFA::Transition DFA::compute_transition(State* q, std::vector<bool> chbst) {
  StateSubset ss(eVA_.size());
      ...
      if (it == capture_reach.end()) {
        it = capture_reach
                 .emplace(std::piecewise_construct,
                          ...
                          std::forward_as_tuple(eVA_.size()))
                 .first;
      }
