...
UDFA::Transition UDFA::next_transition(abstract::DState* dq, char a) {
...
UDFA::Transition UDFA::next_base_transition(abstract::DState* dq, char a) {
  auto* q = dynamic_cast<State*>(dq);
...
UDFA::Transition UDFA::compute_transition(State* q,
                                          const std::vector<bool>& chbst) {
  //   StateSubset ss(nfa_size_);
  ...
  //                           std::forward_as_tuple(nfa_size_))
  //                  .first;
  //       }
