...
std::vector<LogicalVA::State*> const& SearchVA::states() const {
  return states_;
}

LogicalVA::State* SearchVA::initial_state() const {
  return initial_state_;
}

LogicalVA::State* SearchVA::accepting_state() const {
  return accepting_state_;
}

bool SearchVA::has_epsilon() const {
  return has_epsilon_;
}
