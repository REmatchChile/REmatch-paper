...
class ExtendedVA {
 ...
 public:
  ...
  void addCapture(LogicalVA::State* state, std::bitset<32> bs,
                  LogicalVA::State* next);
  ...
  void invTopologicalSortUtil(LogicalVA::State* state,
                              std::queue<LogicalVA::State*>* Q);
