#ifndef EVALUATION_SEGMENT_EVALUATOR_HPP
#define EVALUATION_SEGMENT_EVALUATOR_HPP
...
class SegmentEvaluator : public Evaluator {
 ...
 public:
  static constexpr size_t MIN_PREFIX_READ = 1000;
  static constexpr double MAX_SEGMENT_RATIO = 0.5;
 ...
 private:
  ...
  inline void visit(DFA::State* ns, ECS::Node* passed_node, int64_t pos,
  ...
  size_t segments_tot_size_ = 0;

  bool good_segment_ratio() const;
...
#endif  // EVALUATION_SEGMENT_EVALUATOR_HPP